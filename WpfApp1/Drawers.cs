...
namespace WpfApp1
{
    public class Drawers
    {
        ...
        public void getCuttingList(Drawers understairDrawerUnit)
        {
            ...
            cutList.AddRange(getFirstDrawerUnit(understairDrawerUnit.kicker, understairDrawerUnit.baseWidth,
                understairDrawerUnit.cuttingAngle, understairDrawerUnit.depth,
        ...
        private List<cut> getFirstDrawerUnit(int kicker, int baseWidth, int cuttingAngle, int depth,
            int bottomUpstandHeight, int drawerNumber, int drawerSectionWidth)
        {
            ...
            //bottomUpstandHeight = GetLessThirty(baseWidth, bottomUpstandHeight, drawerSectionWidth, cuttingAngle, sideHeight, tallUnitDoorWidth);
                ...
                int toTheInitialLong = GetLessThirty(baseWidth, bottomUpstandHeight, drawerSectionWidth, cuttingAngle,
                    sideHeight);// getToTheLong(bottomUpstandHeight, cuttingAngle);
